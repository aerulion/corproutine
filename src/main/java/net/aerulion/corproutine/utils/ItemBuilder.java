...
public class ItemBuilder {
    ...
    public static ItemStack createButtonDye(boolean IsExpired) {
        ...
        mDye.setDisplayName(IsExpired ? "§a§lRoutineaufgabe abschließen" : "§7§lRoutineaufgabe noch nicht notwendig");
        mDye.setLore(IsExpired ? null : Arrays.asList("§7§oMittelklick um die Aufgabe dennoch abzuschließen"));
